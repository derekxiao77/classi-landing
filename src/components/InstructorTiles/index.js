...
function ContentFriends() {
  return (
    <div>
      ...
      <span>
        Any user can post a live stream and start teaching today! Classi allows
        users to monetize their content through custom micro-subscriptions and
        tips.
      </span>
    </div>
  );
...
function ContentFree() {
  return (
    <div>
      ...
      <span>
        Connect with your followers in and out of class. Classi’s social feed
        allows you to continue engaging with your followers even after the class
        has finished.
      </span>
    </div>
  );
...
function ContentGoals() {
  return (
    <div>
      ...
      <span>
        On most live fitness apps, users can only interact with the instructor
        by typing comments. Instructors on Classi can interact with select users
        in real-time through video and audio.
      </span>
    </div>
  );
}
