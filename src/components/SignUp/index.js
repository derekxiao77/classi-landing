      ...
      <div className={styles.signUpContainerMobile}>
        ...
        <div className={styles.headerTextMobile}>
          ...
          <img
            src={celebrateEmoji}
            alt=""
            className={styles.celebrateEmojiMobile}
          />
          <img
            src={celebrateEmoji}
            alt=""
        ...
        <div className={styles.signUpTextMobile}>
          Sign up below and be among the first to experience home workouts to
          look forward to.
        </div>
        <SubmitEmail />
        ...
        <div className={styles.contactText}>
          reach us at{" "}
          <a href="mailto:contact@classi.live" style={{ color: "#F86A6A" }}>
            contact@classi.live
          </a>
        </div>
      </div>
  ...
  return (
    <div className={styles.signUpContainer}>
      <div className={styles.headerContainer}>
        <div className={styles.headerText}>Launching in Summer 2020</div>
        <img src={celebrateEmoji} alt="" className={styles.celebrateEmoji} />
      </div>
      <div className={styles.signUpText}>
        Sign up below and be among the first to experience home workouts to look
        forward to.
      </div>
      <SubmitEmail />
